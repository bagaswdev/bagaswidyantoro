...
//================================== Konfirmasi Tambah ==========================================
const konfirmasiTambah = document.querySelectorAll('.konfirmasi-tambah');

konfirmasiTambah.forEach(function (button) {
  button.addEventListener('click', function (e) {
    e.preventDefault();
    var form = $(this).closest('form')[0]; // Ambil elemen form sebagai elemen DOM
    var url = form.action; // Dapatkan URL dari properti action

    // console.log(form); // Cetak URL di konsol
    // console.log(url); // Cetak URL di konsol
    // console.log('asdas');

    Swal.fire({
      title: 'Apakah kamu yakin?',
      text: "Kamu akan menambah data ini.",
      icon: 'info',
      showCancelButton: true,
      confirmButtonText: 'Ya, tambah sekarang!',
      customClass: {
        confirmButton: 'btn btn-primary me-3 waves-effect waves-light',
 ...
 //================================== Konfirmasi Edit ==========================================
const konfirmasiEdit = document.querySelectorAll('.konfirmasi-edit');

konfirmasiEdit.forEach(function (button) {
  button.addEventListener('click', function (e) {
    e.preventDefault();
    var form = $(this).closest('form')[0]; // Ambil elemen form sebagai elemen DOM
    var url = form.action; // Dapatkan URL dari properti action
...
$(document).ready(function() {
        $('.konfirmasi-hapus').on('click', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                     // Mengirimkan permintaan DELETE melalui AJAX
                    $.ajax({
                    url: url,
                    method: 'POST',
                    data: {
  ...
  if (confirmColor) {
    confirmColor.onclick = function () {
      Swal.fire({
        ...
        const confirmButton = document.querySelector('.confirm-text');

        // Mendapatkan nilai href dari tombol
        const href = confirmText.getAttribute('href');

        // Arahkan ke tautan URL saat tombol confirmButton diklik
